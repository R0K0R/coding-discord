...
public class RegisterItem {
    ...
    static Item testSword = new sword(Item.ToolMaterial.IRON);

    public static void RegisterItem() {
        testSword.setUnlocalizedName("op_sword");
        GameRegistry.registerItem(WheatAndSteel, "wheat_and_steel");
        GameRegistry.registerItem(testSword, "op_sword");
    }
    ...
    public static void RegisterItemModel(){
        ...
        ModelLoader.setCustomModelResourceLocation(testSword, 0, new ModelResourceLocation(testSword.getRegistryName()));
    }
}
